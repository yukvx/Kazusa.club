...
--
local function luaDrawing()
    local a=clonefunction(isscriptable)local b=clonefunction(setscriptable)local c={}local d=cloneref(game:GetService("TextService"))local e=cloneref(game:GetService("CoreGui"))local f={Fonts={UI=0,System=1,Plex=2,Monospace=3}}local g=getrenv()local h=getgenv()local i=g.math.pi;local j=g.math.huge;local k=clonefunction(g.assert)local l=clonefunction(g.Color3.new)local m=clonefunction(g.Instance.new)local n=clonefunction(g.math.atan2)local o=clonefunction(g.math.clamp)local p=clonefunction(g.math.max)local q=clonefunction(g.setmetatable)local r=clonefunction(g.string.format)local s=clonefunction(g.typeof)local t=clonefunction(g.task.spawn)local u=clonefunction(g.UDim.new)local v=clonefunction(g.UDim2.fromOffset)local w=clonefunction(g.UDim2.new)local x=clonefunction(g.Vector2.new)local y=clonefunction(game.Destroy)local z=clonefunction(d.GetTextBoundsAsync)local A=clonefunction(game.HttpGet)local B=newcclosure(function(C,D)if isfile(C)then return getcustomasset(C)else writefile(C,D)return getcustomasset(C)end end)local E=protectinstance and clonefunction(protectinstance)local function F(G,H,I)local J=m(G)for K,L in H do if K~="Parent"then J[K]=L end end;if I then for K,L in I do L.Parent=J end end;if E then E(J)end;J.Parent=H.Parent;return J end;do local M={Font.new("rbxasset://fonts/families/Arial.json",Enum.FontWeight.Regular,Enum.FontStyle.Normal),Font.new("rbxasset://fonts/families/HighwayGothic.json",Enum.FontWeight.Regular,Enum.FontStyle.Normal),Font.new("rbxasset://fonts/families/RobotoMono.json",Enum.FontWeight.Regular,Enum.FontStyle.Normal),Font.new("rbxasset://fonts/families/RobotoMono.json",Enum.FontWeight.Regular,Enum.FontStyle.Normal)}for K,L in M do game:GetService("TextService"):GetTextBoundsAsync(F("GetTextBoundsParams",{Text="Hi",Size=12,Font=L,Width=j}))end end;do local N=F("ScreenGui",{DisplayOrder=15,IgnoreGuiInset=true,Name="drawingDirectory",Parent=gethui(),ZIndexBehavior=Enum.ZIndexBehavior.Sibling})local function O(P,Q,R,S)local T=(Q+R)/2;local U=R-Q;P.Position=v(T.X,T.Y)P.Rotation=n(U.Y,U.X)*180/i;P.Size=v(U.Magnitude,S)end;local V=0;local W={}local X={}do local Y={}function Y.new()V=V+1;local Z=V;local _=q({_id=Z,__OBJECT_EXISTS=true,_properties={Color=l(),From=x(),Thickness=1,To=x(),Transparency=1,Visible=false,ZIndex=0},_frame=F("Frame",{Name=Z,AnchorPoint=x(0.5,0.5),BackgroundColor3=l(),BorderSizePixel=0,Parent=N,Position=w(),Size=w(),Visible=false,ZIndex=0})},Y)W[Z]=_;return _ end;function Y:__index(a0)local a1=self._properties[a0]if a1~=nil then return a1 end;return Y[a0]end;function Y:__newindex(a0,L)if self.__OBJECT_EXISTS==true then local a2=self._properties;if a2[a0]==nil or a2[a0]==L or typeof(a2[a0])~=typeof(L)then return end;a2[a0]=L;if a0=="Color"then self._frame.BackgroundColor3=L elseif a0=="From"then self:_updatePosition()elseif a0=="Thickness"then self._frame.Size=v(self._frame.AbsoluteSize.X,p(L,1))elseif a0=="To"then self:_updatePosition()elseif a0=="Transparency"then self._frame.BackgroundTransparency=o(1-L,0,1)elseif a0=="Visible"then self._frame.Visible=L elseif a0=="ZIndex"then self._frame.ZIndex=L end end end;function Y:__iter()return next,self._properties end;function Y:__tostring()return"Drawing"end;function Y:Destroy()W[self._id]=nil;self.__OBJECT_EXISTS=false;y(self._frame)end;function Y:_updatePosition()local a2=self._properties;O(self._frame,a2.From,a2.To,a2.Thickness)end;Y.Remove=Y.Destroy;X.Line=Y end;do local a3={}function a3.new()V=V+1;local Z=V;local a4=q({_id=Z,__OBJECT_EXISTS=true,_properties={Color=l(),Filled=false,NumSides=0,Position=x(),Radius=0,Thickness=1,Transparency=1,Visible=false,ZIndex=0},_frame=F("Frame",{Name=Z,AnchorPoint=x(0.5,0.5),BackgroundColor3=l(),BackgroundTransparency=1,BorderSizePixel=0,Parent=N,Position=w(),Size=w(),Visible=false,ZIndex=0},{F("UICorner",{Name="_corner",CornerRadius=u(1,0)}),F("UIStroke",{Name="_stroke",Color=l(),Thickness=1})})},a3)W[Z]=a4;return a4 end;function a3:__index(a0)local a1=self._properties[a0]if a1~=nil then return a1 end;return a3[a0]end;function a3:__newindex(a0,L)if self.__OBJECT_EXISTS==true then local a2=self._properties;if a2[a0]==nil or a2[a0]==L or typeof(a2[a0])~=typeof(L)then return end;a2[a0]=L;if a0=="Color"then self._frame.BackgroundColor3=L;self._frame._stroke.Color=L elseif a0=="Filled"then self._frame.BackgroundTransparency=L and 1-a2.Transparency or 1 elseif a0=="Position"then self._frame.Position=v(L.X,L.Y)elseif a0=="Radius"then self:_updateRadius()elseif a0=="Thickness"then self._frame._stroke.Thickness=p(L,1)self:_updateRadius()elseif a0=="Transparency"then self._frame._stroke.Transparency=1-L;if a2.Filled then self._frame.BackgroundTransparency=1-L end elseif a0=="Visible"then self._frame.Visible=L elseif a0=="ZIndex"then self._frame.ZIndex=L end end end;function a3:__iter()return next,self._properties end;function a3:__tostring()return"Drawing"end;function a3:Destroy()W[self._id]=nil;self.__OBJECT_EXISTS=false;y(self._frame)end;function a3:_updateRadius()local a2=self._properties;local a5=a2.Radius*2-a2.Thickness*2;self._frame.Size=v(a5,a5)end;a3.Remove=a3.Destroy;X.Circle=a3 end;do local a6={[f.Fonts.UI]=Font.new("rbxasset://fonts/families/Arial.json",Enum.FontWeight.Regular,Enum.FontStyle.Normal),[f.Fonts.System]=Font.new("rbxasset://fonts/families/HighwayGothic.json",Enum.FontWeight.Regular,Enum.FontStyle.Normal),[f.Fonts.Plex]=Font.new("rbxasset://fonts/families/RobotoMono.json",Enum.FontWeight.Regular,Enum.FontStyle.Normal),[f.Fonts.Monospace]=Font.new("rbxasset://fonts/families/RobotoMono.json",Enum.FontWeight.Regular,Enum.FontStyle.Normal)}local a7={}function a7.new()V=V+1;local Z=V;local a8=q({_id=Z,__OBJECT_EXISTS=true,_properties={Center=false,Color=l(),Font=0,Outline=false,OutlineColor=l(),Position=x(),Size=12,Text="",TextBounds=x(),Transparency=1,Visible=false,ZIndex=0},_frame=F("TextLabel",{Name=Z,BackgroundTransparency=1,FontFace=a6[0],Parent=N,Position=w(),Size=w(),Text="",TextColor3=l(),TextSize=12,TextXAlignment=Enum.TextXAlignment.Left,TextYAlignment=Enum.TextYAlignment.Top,Visible=false,ZIndex=0},{F("UIStroke",{Name="_stroke",Color=l(),Enabled=false,Thickness=1})})},a7)W[Z]=a8;return a8 end;function a7:__index(a0)local a1=self._properties[a0]if a1~=nil then return a1 end;return a7[a0]end;function a7:__newindex(a0,L)if self.__OBJECT_EXISTS==true then local a2=self._properties;if a0=="TextBounds"or a2[a0]==nil or a2[a0]==L or typeof(a2[a0])~=typeof(L)then return end;a2[a0]=L;if a0=="Center"then self._frame.TextXAlignment=L and Enum.TextXAlignment.Center or Enum.TextXAlignment.Left elseif a0=="Color"then self._frame.TextColor3=L elseif a0=="Font"then self._frame.FontFace=a6[L]self:_updateTextBounds()elseif a0=="Outline"then self._frame._stroke.Enabled=L elseif a0=="OutlineColor"then self._frame._stroke.Color=L elseif a0=="Position"then self._frame.Position=v(L.X,L.Y)elseif a0=="Size"then self._frame.TextSize=L;self:_updateTextBounds()elseif a0=="Text"then self._frame.Text=L;self:_updateTextBounds()elseif a0=="Transparency"then self._frame.TextTransparency=1-L;self._frame._stroke.Transparency=1-L elseif a0=="Visible"then self._frame.Visible=L elseif a0=="ZIndex"then self._frame.ZIndex=L end end end;function a7:__iter()return next,self._properties end;function a7:__tostring()return"Drawing"end;function a7:Destroy()W[self._id]=nil;self.__OBJECT_EXISTS=false;y(self._frame)end;function a7:_updateTextBounds()local a2=self._properties;a2.TextBounds=z(d,F("GetTextBoundsParams",{Text=a2.Text,Size=a2.Size,Font=a6[a2.Font],Width=j}))end;a7.Remove=a7.Destroy;X.Text=a7 end;do local a9={}function a9.new()V=V+1;local Z=V;local aa=q({_id=Z,__OBJECT_EXISTS=true,_properties={Color=l(),Filled=false,Position=x(),Size=x(),Thickness=1,Transparency=1,Visible=false,ZIndex=0},_frame=F("Frame",{BackgroundColor3=l(),BackgroundTransparency=1,BorderSizePixel=0,Parent=N,Position=w(),Size=w(),Visible=false,ZIndex=0},{F("UIStroke",{Name="_stroke",Color=l(),Thickness=1,LineJoinMode=Enum.LineJoinMode.Miter})})},a9)W[Z]=aa;return aa end;function a9:__index(a0)local a1=self._properties[a0]if a1~=nil then return a1 end;return a9[a0]end;function a9:__newindex(a0,L)if self.__OBJECT_EXISTS==true then local a2=self._properties;if a2[a0]==nil or a2[a0]==L or typeof(a2[a0])~=typeof(L)then return end;a2[a0]=L;if a0=="Color"then self._frame.BackgroundColor3=L;self._frame._stroke.Color=L elseif a0=="Filled"then self._frame.BackgroundTransparency=L and 1-a2.Transparency or 1 elseif a0=="Position"then self:_updateScale()elseif a0=="Size"then self:_updateScale()elseif a0=="Thickness"then self._frame._stroke.Thickness=L;self:_updateScale()elseif a0=="Transparency"then self._frame._stroke.Transparency=1-L;if a2.Filled then self._frame.BackgroundTransparency=1-L end elseif a0=="Visible"then self._frame.Visible=L elseif a0=="ZIndex"then self._frame.ZIndex=L end end end;function a9:__iter()return next,self._properties end;function a9:__tostring()return"Drawing"end;function a9:Destroy()W[self._id]=nil;self.__OBJECT_EXISTS=false;y(self._frame)end;function a9:_updateScale()local a2=self._properties;self._frame.Position=v(a2.Position.X+a2.Thickness,a2.Position.Y+a2.Thickness)local S=a2.Thickness;self._frame.Size=v(a2.Size.X-S*2,a2.Size.Y-S*2)end;a9.Remove=a9.Destroy;X.Square=a9 end;do local ab={}function ab.new()V=V+1;local Z=V;local ac=q({_id=Z,_imageId=0,__OBJECT_EXISTS=true,_properties={Color=l(1,1,1),Data="",Position=x(),Rounding=0,Size=x(),Transparency=1,Uri="",Visible=false,ZIndex=0},_frame=F("ImageLabel",{BackgroundTransparency=1,BorderSizePixel=0,Image="",ImageColor3=l(1,1,1),Parent=N,Position=w(),Size=w(),Visible=false,ZIndex=0},{F("UICorner",{Name="_corner",CornerRadius=u()})})},ab)W[Z]=ac;return ac end;function ab:__index(a0)k(a0~="Data",r("Attempt to read writeonly property '%s'",a0))if a0=="Loaded"then return self._frame.IsLoaded end;local a1=self._properties[a0]if a1~=nil then return a1 end;return ab[a0]end;function ab:__newindex(a0,L)if self.__OBJECT_EXISTS==true then local a2=self._properties;if a2[a0]==nil or a2[a0]==L or typeof(a2[a0])~=typeof(L)then return end;a2[a0]=L;if a0=="Color"then self._frame.ImageColor3=L elseif a0=="Data"then self:_newImage(L)elseif a0=="Position"then self._frame.Position=v(L.X,L.Y)elseif a0=="Rounding"then self._frame._corner.CornerRadius=u(0,L)elseif a0=="Size"then self._frame.Size=v(L.X,L.Y)elseif a0=="Transparency"then self._frame.ImageTransparency=1-L elseif a0=="Uri"then self:_newImage(L,true)elseif a0=="Visible"then self._frame.Visible=L elseif a0=="ZIndex"then self._frame.ZIndex=L end end end;function ab:__iter()return next,self._properties end;function ab:__tostring()return"Drawing"end;function ab:Destroy()W[self._id]=nil;self.__OBJECT_EXISTS=false;y(self._frame)end;function ab:_newImage(D,ad)t(function()self._imageId=self._imageId+1;local C=r("%s-%s.png",self._id,self._imageId)if ad then local ae;while ae==nil do local af,ag=pcall(A,game,D,true)if af then ae=ag elseif string.find(string.lower(ag),"too many requests")then task.wait(3)else error(ag,2)return end end;self._properties.Data=D else self._properties.Uri=""end;self._frame.Image=B(C,D)end)end;ab.Remove=ab.Destroy;X.Image=ab end;do local ah={}function ah.new()V=V+1;local Z=V;local ai=q({_id=Z,__OBJECT_EXISTS=true,_properties={Color=l(),Filled=false,PointA=x(),PointB=x(),PointC=x(),Thickness=1,Transparency=1,Visible=false,ZIndex=0},_frame=F("Frame",{BackgroundTransparency=1,Parent=N,Size=w(1,0,1,0),Visible=false,ZIndex=0},{F("Frame",{Name="_line1",AnchorPoint=x(0.5,0.5),BackgroundColor3=l(),BorderSizePixel=0,Position=w(),Size=w(),ZIndex=0}),F("Frame",{Name="_line2",AnchorPoint=x(0.5,0.5),BackgroundColor3=l(),BorderSizePixel=0,Position=w(),Size=w(),ZIndex=0}),F("Frame",{Name="_line3",AnchorPoint=x(0.5,0.5),BackgroundColor3=l(),BorderSizePixel=0,Position=w(),Size=w(),ZIndex=0})})},ah)W[Z]=ai;return ai end;function ah:__index(a0)local a1=self._properties[a0]if a1~=nil then return a1 end;return ah[a0]end;function ah:__newindex(a0,L)if self.__OBJECT_EXISTS==true then local a2,P=self._properties,self._frame;if a2[a0]==nil or a2[a0]==L or typeof(a2[a0])~=typeof(L)then return end;a2[a0]=L;if a0=="Color"then P._line1.BackgroundColor3=L;P._line2.BackgroundColor3=L;P._line3.BackgroundColor3=L elseif a0=="Filled"then elseif a0=="PointA"then self:_updateVertices({{P._line1,a2.PointA,a2.PointB},{P._line3,a2.PointC,a2.PointA}})if a2.Filled then self:_calculateFill()end elseif a0=="PointB"then self:_updateVertices({{P._line1,a2.PointA,a2.PointB},{P._line2,a2.PointB,a2.PointC}})if a2.Filled then self:_calculateFill()end elseif a0=="PointC"then self:_updateVertices({{P._line2,a2.PointB,a2.PointC},{P._line3,a2.PointC,a2.PointA}})if a2.Filled then self:_calculateFill()end elseif a0=="Thickness"then local S=p(L,1)P._line1.Size=v(P._line1.AbsoluteSize.X,S)P._line2.Size=v(P._line2.AbsoluteSize.X,S)P._line3.Size=v(P._line3.AbsoluteSize.X,S)elseif a0=="Transparency"then P._line1.BackgroundTransparency=1-L;P._line2.BackgroundTransparency=1-L;P._line3.BackgroundTransparency=1-L elseif a0=="Visible"then self._frame.Visible=L elseif a0=="ZIndex"then self._frame.ZIndex=L end end end;function ah:__iter()return next,self._properties end;function ah:__tostring()return"Drawing"end;function ah:Destroy()W[self._id]=nil;self.__OBJECT_EXISTS=false;y(self._frame)end;function ah:_updateVertices(aj)local S=self._properties.Thickness;for K,L in aj do O(L[1],L[2],L[3],S)end end;function ah:_calculateFill()end;ah.Remove=ah.Destroy;X.Triangle=ah end;do local ak={}function ak.new()V=V+1;local Z=V;local al=q({_id=Z,__OBJECT_EXISTS=true,_properties={Color=l(),Filled=false,PointA=x(),PointB=x(),PointC=x(),PointD=x(),Thickness=1,Transparency=1,Visible=false,ZIndex=0},_frame=F("Frame",{BackgroundTransparency=1,Parent=N,Size=w(1,0,1,0),Visible=false,ZIndex=0},{F("Frame",{Name="_line1",AnchorPoint=x(0.5,0.5),BackgroundColor3=l(),BorderSizePixel=0,Position=w(),Size=w(),ZIndex=0}),F("Frame",{Name="_line2",AnchorPoint=x(0.5,0.5),BackgroundColor3=l(),BorderSizePixel=0,Position=w(),Size=w(),ZIndex=0}),F("Frame",{Name="_line3",AnchorPoint=x(0.5,0.5),BackgroundColor3=l(),BorderSizePixel=0,Position=w(),Size=w(),ZIndex=0}),F("Frame",{Name="_line4",AnchorPoint=x(0.5,0.5),BackgroundColor3=l(),BorderSizePixel=0,Position=w(),Size=w(),ZIndex=0})})},ak)W[Z]=al;return al end;function ak:__index(a0)local a1=self._properties[a0]if a1~=nil then return a1 end;return ak[a0]end;function ak:__newindex(a0,L)if self.__OBJECT_EXISTS==true then local a2,P=self._properties,self._frame;if a2[a0]==nil or a2[a0]==L or typeof(a2[a0])~=typeof(L)then return end;a2[a0]=L;if a0=="Color"then P._line1.BackgroundColor3=L;P._line2.BackgroundColor3=L;P._line3.BackgroundColor3=L;P._line4.BackgroundColor3=L elseif a0=="Filled"then elseif a0=="PointA"then self:_updateVertices({{P._line1,a2.PointA,a2.PointB},{P._line4,a2.PointD,a2.PointA}})if a2.Filled then self:_calculateFill()end elseif a0=="PointB"then self:_updateVertices({{P._line1,a2.PointA,a2.PointB},{P._line2,a2.PointB,a2.PointC}})if a2.Filled then self:_calculateFill()end elseif a0=="PointC"then self:_updateVertices({{P._line2,a2.PointB,a2.PointC},{P._line3,a2.PointC,a2.PointD}})if a2.Filled then self:_calculateFill()end elseif a0=="PointD"then self:_updateVertices({{P._line3,a2.PointC,a2.PointD},{P._line4,a2.PointD,a2.PointA}})if a2.Filled then self:_calculateFill()end elseif a0=="Thickness"then local S=p(L,1)P._line1.Size=v(P._line1.AbsoluteSize.X,S)P._line2.Size=v(P._line2.AbsoluteSize.X,S)P._line3.Size=v(P._line3.AbsoluteSize.X,S)P._line4.Size=v(P._line3.AbsoluteSize.X,S)elseif a0=="Transparency"then P._line1.BackgroundTransparency=1-L;P._line2.BackgroundTransparency=1-L;P._line3.BackgroundTransparency=1-L;P._line4.BackgroundTransparency=1-L elseif a0=="Visible"then self._frame.Visible=L elseif a0=="ZIndex"then self._frame.ZIndex=L end end end;function ak:__iter()return next,self._properties end;function ak:__tostring()return"Drawing"end;function ak:Destroy()W[self._id]=nil;self.__OBJECT_EXISTS=false;y(self._frame)end;function ak:_updateVertices(aj)local S=self._properties.Thickness;for K,L in aj do O(L[1],L[2],L[3],S)end end;function ak:_calculateFill()end;ak.Remove=ak.Destroy;X.Quad=ak end;f.new=newcclosure(function(am)return k(X[am],r("Invalid drawing type '%s'",am)).new()end)f.clear=newcclosure(function()for K,L in W do if L.__OBJECT_EXISTS then L:Destroy()end end end)f.cache=W end;setreadonly(f,true)setreadonly(f.Fonts,true)h.Drawing=f;h.cleardrawcache=f.clear;h.isrenderobj=newcclosure(function(am)return tostring(am)=="Drawing"end)local an=clonefunction(isrenderobj)h.getrenderproperty=newcclosure(function(am,ao)k(an(am),r("invalid argument #1 to 'getrenderproperty' (Drawing expected, got %s)",s(am)))return am[ao]end)h.setrenderproperty=newcclosure(function(am,ao,ap)k(an(am),r("invalid argument #1 to 'setrenderproperty' (Drawing expected, got %s)",s(am)))am[ao]=ap end)h.drawingLoaded=true
    end
luaDrawing()
--
...
do
    ...
    function library:Loader(info)
        ...
        function window:CloseContent()
            if window.currentContent.dropdown and window.currentContent.dropdown.open then
                ...
                utility:LoadImage(dropdown.dropdown_image, "arrow_down", images["arrowdown"])
                --
            ...
            elseif window.currentContent.multibox and window.currentContent.multibox.open then
                ...
                utility:LoadImage(multibox.multibox_image, "arrow_down", images["arrowdown"])
                --
    ...
    function library:New(info)
        ...
        -- // Esp Preview
-- https://raw.githubusercontent.com/yukvx/robloxlol/refs/heads/main/gamesneeze/espPreview.lua
        --
        function window:SetName(Name)
            title.Text = Name
        end
    ...
    function pages:PlayerList(info)
        ...
        for Index = 1, 1 do
            ...
            --
            utility:LoadImage(button_image, "arrow_down", images["arrowdown"])
            --
            ...
            function button:Open()
                window:CloseContent()
                button.open = not button.open
                utility:LoadImage(button_image, "arrow_up", images["arrowup"])
                --
    ...
    function sections:Toggle(info)
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", images["gradient"])
            --
    ...
    function sections:TextBox(info)
        ...
        --
        utility:LoadImage(textbox_gradient, "gradient", images["gradient"])
        --
        ...
        library.began[#library.began + 1] = function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and textbox_outline.Visible and window.isVisible then
                if reactive and utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + textbox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + textbox.axis + 20}) and not window:IsOverContent() then
                    task.spawn(function()
                        utility:LoadImage(textbox_gradient, "gradientdown", images["gradientdown"]) 
                        --
                        task.wait(0.15)
                        --
                        utility:LoadImage(textbox_gradient, "gradient", images["gradient"]) 
    ...
    function sections:Dropdown(info)
        ...
        --
        utility:LoadImage(dropdown_image, "arrow_down", images["arrowdown"])
        utility:LoadImage(dropdown__gradient, "gradient", images["gradient"])
        --
        if max then
        ...
        library.began[#library.began + 1] = function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and dropdown_outline.Visible then
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + dropdown.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + dropdown.axis + (name and (15 + 20) or (20))}) and not window:IsOverContent() then
                    task.spawn(function()
                        utility:LoadImage(dropdown__gradient, "gradientdown", images["gradientdown"]) 
                        --
                        task.wait(0.15)
                        --
                        utility:LoadImage(dropdown__gradient, "gradient", images["gradient"]) 
                    ...
                    if not dropdown.open then
                        window:CloseContent()
                        dropdown.open = not dropdown.open
                        utility:LoadImage(dropdown_image, "arrow_up", images["arrowup"])
                        --
    ...
    function sections:Multibox(info)
        ...
        --
        utility:LoadImage(multibox_image, "arrow_down", images["arrowdown"])
        utility:LoadImage(multibox__gradient, "gradient", images["gradient"])
        --
        ...
        library.began[#library.began + 1] = function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and multibox_outline.Visible then
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + (name and 15 or 0) + 20}) and not window:IsOverContent() then
                    task.spawn(function()
                        utility:LoadImage(multibox__gradient, "gradientdown", images["gradientdown"]) 
                        --
                        task.wait(0.15)
                        --
                        utility:LoadImage(multibox__gradient, "gradient", images["gradient"]) 
                    ...
                    if not multibox.open then
                        window:CloseContent()
                        multibox.open = not multibox.open
                        utility:LoadImage(multibox_image, "arrow_up", images["arrowup"])
                        --
                        ...
                        for i,v in pairs(multibox.options) do
                            ...
                            --
                            utility:LoadImage(multibox_value_gradient, "gradient", images["gradient"])]]
                            --
